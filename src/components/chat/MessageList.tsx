      ...
      <div className="space-y-6 max-w-4xl mx-auto w-full">
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            <p className="text-neutral-700 mb-1">Start a conversation to generate React components</p>
            <p className="text-neutral-500">I can help you create buttons, forms, cards, and more</p>
          </div>
        )}
                            ...
                            return (
                              <div key={partIndex} className="inline-flex items-center gap-2 mt-2 px-3 py-1.5 bg-neutral-50 rounded-lg text-xs font-mono border border-neutral-200">
                                {toolPart.state === "output" ? (
                                  <>
                                    <div className="w-2 h-2 rounded-full bg-emerald-500"></div>
                                    <span className="text-neutral-700">{toolPart.type.replace(/^tool-/, "")}</span>
                                  </>
                                ) : (
                                  <>
                                    <Loader2 className="w-3 h-3 animate-spin text-blue-600" />
